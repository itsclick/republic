...
$query="SELECT id,p_id,active,public,p_title,p_price,photo,question,catid from questions where catid=' ' ORDER BY id DESC";
  ...
  @$image=$data['uploadFile'];
    ?>
                  <tr>
                                         ...
                                         <td><?php echo $i++; ?></td>
                                        <td> <?php echo $p_id ?></td>
                                        <td> <?php echo'<img src="https://salesyards.com/'.$image.'" alt="Product Image" class="img-size-50">';?></td>
