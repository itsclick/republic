...
$query="SELECT * from orders WHERE payout=0 AND payment_status=1";
...
$vcom = $fpp-$ycom;
    ?>
                  <tr>
                                        ...
                                        <td bgcolor="#293A4A"><font color="#FFFFFF"><?php echo $ycom ?></font></td>
                                        <td bgcolor="#003333"><font color="#FFFFFF"><?php echo $vcom ?></font></td>
                                        <td> 
